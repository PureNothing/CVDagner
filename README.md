...
| Добавление камеры | Меню вызова отчетов | Tool Сalling по Алертам | Полный отчет от Агента |
|-|-|-|-|
| <img src="assets/adding.jpg" width="260"/> | <img src="assets/menu.jpg" width="260"/> | <img src="assets/toolcalling.jpg" width="260"/> | <img src="assets/otchet.jpg" width="260"/> |
...
flowchart TD
    ...
    OP -->|выбирает камеру и загружает видео| FE[frontend_VideoProduce]
    FE -->|видео отправляется в сервис обработки| BV[backend_VideoProduce]
